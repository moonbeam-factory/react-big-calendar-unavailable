# react-big-calendar-unavailable
...
`npm install react-big-calendar-unavailable --save`
...
```
$ git clone git@github.com:gianchandania/react-big-calendar-unavailable.git
$ cd react-big-calendar-unavailable
$ npm install
$ npm run examples
```
...
`react-big-calendar-unavailable` includes two options for handling the date formatting and culture localization, depending
...
```js
import BigCalendar from 'react-big-calendar-unavailable'
